...
# cv2.imshow("brightness", cv2.cvtColor(X[0], cv2.COLOR_RGB2BGR))
# cv2.imshow("translate", cv2.cvtColor(X[0], cv2.COLOR_RGB2BGR))
# cv2.imshow("crop", cv2.cvtColor(X[0], cv2.COLOR_RGB2BGR))
# cv2.waitKey(0)
